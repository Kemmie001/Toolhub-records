    ...
    return {
      tools: [
...

        {
          ...
          name: "OpenRefine",
          description:
            "A free data wrangling tool to work with messy data, to clean and improve it, and to connect it with knowledge bases",
          missing: false,
          authors: ["Pintoch"],
        },
        {
        ...
        },
        {
          ...
          description:
            "Tool to edit Wikidata items, based on a simple set of text commands.",
          missing: false,
          authors: ["Magnus Manske"],
        },
      ...
      missingTools: [
        ...
        },
        {
          ...
          name: "CropTool",
          description:
            "Tool for cropping images at Wikimedia Commons and other Wikimedia sites",
          missing: true,
      ...
      <div class="md:flex items-start gap-5 w-full">
        ...
        <div class="bg-white shadow-md flex-1 rounded-md px-4 py-5">
          ...
          <div class="flex mt-8 w-11/12 text-light justify-end">
            <router-link to="/leader-board"> View All </router-link>
          </div>
        </div>
      </div>
    </div>
